...
import { CheckCircle2, Droplets, Flame, Moon, TrendingUp } from "lucide-react";
...
export default function Dashboard() {
  ...
  return (
    <Sidebar>
      <main className="flex-1 bg-base-200 text-base-content p-4 lg:p-8 min-h-screen transition-colors duration-200">
        <div className="mx-auto max-w-7xl space-y-6">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <h1 className="mt-1 text-2xl font-bold text-base-content lg:text-3xl tracking-tight">
            ...
            <div className="relative overflow-hidden rounded-2xl px-5 py-3.5 bg-linear-to-br from-orange-500 via-amber-500 to-yellow-500 text-white shadow-md sm:w-64">
              ...
              <div className="mt-0.5 flex items-end gap-1">
                ...
                <span className="mb-0.5 text-xs font-medium text-orange-100">
                  days
                </span>
              </div>
              <div className="mt-2.5 flex items-center justify-between rounded-lg bg-white/10 px-2.5 py-1 text-[11px] backdrop-blur-md">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-linear-to-r from-primary via-secondary to-accent p-6 lg:p-8 text-primary-content shadow-xl">
            <div className="max-w-xl relative z-10">
              ...
              <p className="mt-2 text-sm opacity-80 leading-relaxed">
                ...
                improve optimal muscle recovery.
              </p>
            </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {statsConfig.map((stat) => {
              ...
              return (
                <div
                  key={stat.label}
                  className="rounded-2xl border border-base-300 bg-base-100 p-5 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-md"
                >
          ...
          <div className="grid gap-6 xl:grid-cols-2">
            ...
            <div className="rounded-2xl border border-base-300 bg-base-100 p-6 shadow-sm flex flex-col justify-between">
              <div>
                <div className="mb-4 flex items-center justify-between">
                  <h2 className="text-base font-bold">Weekly Progress</h2>
            ...
            <div className="rounded-2xl border border-base-300 bg-base-100 p-6 shadow-sm">
              <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <h2 className="text-base font-bold">Health Trends</h2>
                <select className="select select-sm border-base-300 bg-base-200 font-medium text-xs rounded-xl focus:outline-none">
              ...
              <div className="mb-6 flex flex-wrap gap-4 text-xs font-semibold">
                <span className="flex items-center gap-1 opacity-70">
                  <span className="w-2.5 h-2.5 bg-info rounded-full inline-block" />{" "}
                  Hydration
                </span>
                <span className="flex items-center gap-1 opacity-70">
                ...
                <span className="flex items-center gap-1 opacity-70">
                  <span className="w-2.5 h-2.5 bg-warning rounded-full inline-block" />{" "}
                  Calories
                </span>
              </div>

              {/* Bar Metric Stack Layout */}
              <div className="flex h-48 items-end gap-3 px-2 pt-4 border-b border-base-300">
                {trendData.map((data) => (
                  <div
                    key={data.label}
                  ...
                  >
                    ...
                    <span className="mt-2 text-[11px] font-bold opacity-50">
                      {data.label}
                    </span>
                  </div>
                ))}
